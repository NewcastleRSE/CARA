        ...
        data: [
          {
            ...
            dataPoints: [
              ...
              { label: 'Gist', y: paragraph.gist.correct.count / (paragraph.gist.correct.count + paragraph.gist.incorrect.count) * 100 }
            ]
          }
        ]
      });
    ...
    function singleWordSetup() {
      return {
        ...
        columns: [
          ...
          {title: 'Time', dataKey: 'time'},
          {title: 'Target Word', dataKey: 'targetWord'},
          {title: 'Related', dataKey: 'distractor1'},
          {title: 'Unrelated', dataKey: 'distractor2'},
          {title: 'Noun/Verb', dataKey: 'nounVerb'},
          {title: 'Concrete/Abstract', dataKey: 'concreteAbstract'}
        ],
        rows: [],
